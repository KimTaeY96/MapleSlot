...
const assetDir = "C:/Users/ghddj/Desktop/AI/MSW/GeneratedAssets/SlotMachineUI/layers/runtime";
const manifestPath = "C:/Users/ghddj/Desktop/AI/MSW/GeneratedAssets/SlotMachineUI/msw_resource_manifest.json";
const assets = [
  ["slotLayerCabinetFrame", "slot_layer_cabinet_frame.png"],
  ["slotLayerTopEmblem", "slot_layer_top_emblem.png"],
  ["slotLayerReelWindowFrame", "slot_layer_reel_window_frame.png"],
  ["slotLayerReelColumnBackground", "slot_layer_reel_column_background.png"],
  ["slotLayerInfoPanel", "slot_layer_info_panel.png"],
  ["slotSpinButtonNormal", "slot_spin_button_normal.png"],
  ["slotSpinButtonHoverPressed", "slot_spin_button_hover_pressed.png"],
  ["slotSpinButtonDisabled", "slot_spin_button_disabled.png"],
];
...
async function uploadOne(key, fileName) {
  ...
  const commonArgs = {
    ...
    subcategory: "object",
    name: baseName,
    description: `Textless generated layered slot UI asset: ${baseName}. Original project asset.`,
...
await mcp("initialize", {
  ...
  capabilities: {},
  clientInfo: { name: "codex-slot-ui-layer-upload", version: "0.1.0" },
});
...
console.log(`Merged ${assets.length} layered asset(s) into ${manifestPath}`);
