...
const assetDir = "C:/Users/ghddj/Desktop/AI/MSW/GeneratedAssets/SlotMachineUI/wide/runtime";
const manifestPath = "C:/Users/ghddj/Desktop/AI/MSW/GeneratedAssets/SlotMachineUI/msw_resource_manifest.json";

const assets = [
  ["slotWideCabinetFrame", "slot_wide_cabinet_frame.png"],
  ["slotWideReelWindowFrame", "slot_wide_reel_window_frame.png"],
  ["slotWideBottomPanelEmpty", "slot_wide_bottom_panel_empty.png"],
  ["slotWideBottomPanelWideBox", "slot_wide_bottom_panel_wide_box.png"],
  ["slotWideDropdownList", "slot_wide_dropdown_list.png"],
  ["slotWideTitleOrnament", "slot_wide_title_ornament_imagegen_v3.png"],
  ["slotWideBaseBetMultiplierDivider", "slot_wide_basebet_multiplier_divider_imagegen_v3.png"],
  ["slotWideMultiplierSelectedGlow", "slot_wide_multiplier_selected_glow.png"],
];
...
async function uploadOne(key, fileName) {
  ...
  const commonArgs = {
    ...
    subcategory: "object",
    name: baseName,
    description: `Textless generated wide casino-style slot UI asset: ${baseName}. Original project asset.`,
...
await mcp("initialize", {
  ...
  capabilities: {},
  clientInfo: { name: "codex-slot-ui-wide-upload", version: "0.1.0" },
});
...
console.log(`Merged ${assets.length} asset(s) into ${manifestPath}`);
