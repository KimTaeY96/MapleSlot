export const combatSheets = {
  ...
  CombatLanes: {
    ...
    rows: [
      [1, 1, "map01", "UPPER", 1, 2.1, 6, false, false, "CombatHarness/Lanes/UPPER/Spawn", "CombatHarness/Lanes/UPPER/BoundsLeft", "CombatHarness/Lanes/UPPER/BoundsRight", true, "Future upper-lane area skill target"],
      [2, 1, "map01", "CENTER", 2, 0, 6, true, true, "CombatHarness/Lanes/CENTER/Spawn", "CombatHarness/Lanes/CENTER/BoundsLeft", "CombatHarness/Lanes/CENTER/BoundsRight", true, "Initial basic attack hunting lane"],
      [3, 1, "map01", "LOWER", 3, -2.1, 6, false, false, "CombatHarness/Lanes/LOWER/Spawn", "CombatHarness/Lanes/LOWER/BoundsLeft", "CombatHarness/Lanes/LOWER/BoundsRight", true, "Future lower-lane area skill target"],
    ],
  },
  MonsterDefinitions: {
    columns: [
