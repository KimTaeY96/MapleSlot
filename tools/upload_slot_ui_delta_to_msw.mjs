...
const assets = [
  ["reelFrameCleanRectsafe", "casino_slot_ui_reel_frame_clean_rectsafe.png"],
  ["controlsPanelCleanRectsafe", "casino_slot_ui_controls_panel_clean_rectsafe.png"],
  ["winGlowLoop", "casino_slot_ui_win_glow_loop_8f.png"],
];
...
await mcp("initialize", {
  ...
  capabilities: {},
  clientInfo: { name: "codex-slot-ui-delta-upload", version: "0.1.0" },
});
